...
for target in targets:
    ...
    param_grid = {
        ...
        'max_depth': [5],  # Reduce depth search space
        'learning_rate': [0.05]  # Keep only 2 learning rates
    }
    ...
    # **Train LightGBM as an alternative model (parallelized)**
    lgb_model = lgb.LGBMClassifier(n_estimators=200, max_depth=8, learning_rate=0.1, random_state=42, n_jobs=-1)
...
'''
✅ XGBoost Accuracy for SemifinalWinner_East_West: 0.6891
✅ LightGBM Accuracy for SemifinalWinner_East_West: 0.3210
🔥 Best Model for SemifinalWinner_East_West: **XGBoost** with params: {'n_estimators': 200, 'max_depth': 5, 'learning_rate': 0.05}


✅ XGBoost Accuracy for SemifinalWinner_South_Midwest: 0.6408
✅ LightGBM Accuracy for SemifinalWinner_South_Midwest: 0.2504
🔥 Best Model for SemifinalWinner_South_Midwest: **XGBoost** with params: {'n_estimators': 100, 'max_depth': 5, 'learning_rate': 0.05}


✅ XGBoost Accuracy for NationalChampion: 0.4709
✅ LightGBM Accuracy for NationalChampion: 0.1204
🔥 Best Model for NationalChampion: **XGBoost** with params: {'n_estimators': 200, 'max_depth': 5, 'learning_rate': 0.05}
'''
